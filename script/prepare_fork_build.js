...
new Promise((resolve, reject) => {
  ...
  .then((dirPath) => {
    ...
    source.on("end", function () {
      ...
      const electrondist_zip = path.join(__dirname, '..', '..', "out", "Release", "dist.zip");
      const electrondist_zip_renamed = path.join(__dirname, '..', "..", "out", electrondist_zip_filename);
      fse.copySync(electrondist_zip, electrondist_zip_renamed, { overwrite: true });

      console.log("zip with electron binaries have to be uploaded to github too : " + electrondist_zip_renamed);
